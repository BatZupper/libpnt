...
int main(int argc, char *argv[]) {
    ...
    printf("filename: %s height: %u width: %u metadata: %s data_size: %u\n", image0.filename, image0.height, image0.width, image0.md5, image0.data_size);
    ImageHeader image1 = getPNTImageHeader(pntfile, 1);
    printf("filename: %s height: %u width: %u metadata: %s data_size: %u\n", image1.filename, image1.height, image1.width, image1.md5, image1.data_size);
    ImageHeader image2 = getPNTImageHeader(pntfile, 2);
    printf("filename: %s height: %u width: %u metadata: %s data_size: %u\n", image2.filename, image2.height, image2.width, image2.md5, image2.data_size);
    ImageHeader image3 = getPNTImageHeader(pntfile, 3);
    printf("filename: %s height: %u width: %u metadata: %s data_size: %u\n", image3.filename, image3.height, image3.width, image3.md5, image3.data_size);
    return 0;
}